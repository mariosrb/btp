...
const AboutDicate = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
            ...
            <div className="lg:col-span-8">
              <div className="space-y-8">
                ...
                <p className="text-xl md:text-2xl text-slate-300 font-light max-w-2xl">
                  Un savoir-faire transmis avec passion. Quatre valeurs nous guident :
                  l'héritage familial, la qualité artisanale, la confiance mutuelle
                  et le respect absolu des délais.
                </p>
              </div>
            </div>
      ...
      {/* Section Evolution avec timeline moderne */}
      <div className="relative -mt-12 z-20">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            {evolution.map((item, index) => (
              <div key={index} className="bg-white shadow-xl p-6 hover:-translate-y-2 transition-all duration-300">
      ...
      <div className="max-w-7xl mx-auto px-4 py-20 space-y-20">
        ...
        {/* Notre Histoire - Layout asymétrique */}
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6 text-slate-700 leading-relaxed">
                <div className="bg-white p-6 shadow-lg border-l-4 border-blue-600">
                  ...
                  <p>
                    Tout a commencé par une transmission de savoir-faire de père en fils.
                    Cette expertise artisanale, héritée de générations de bâtisseurs,
                    constitue le socle de notre entreprise. Nous étions 7, unis par cette même passion du travail bien fait.
                  </p>
                </div>
                ...
                <div className="bg-white p-6 shadow-lg border-l-4 border-yellow-500">
                  ...
                  <p>
                    Chez DICATE, chaque geste compte. Notre savoir-faire artisanal se traduit
                    par une attention minutieuse aux détails, l'utilisation de techniques éprouvées
                    et une exigence constante d'excellence. Pas de compromis sur la qualité, jamais.
                  </p>
                </div>
                ...
                <div className="bg-white p-6 shadow-lg border-l-4 border-slate-600">
                  ...
                  <p>
                    Construire une relation de confiance avec nos clients, c'est notre priorité absolue.
                    Transparence dans les devis, communication constante sur l'avancement, conseils avisés...
                ...
                <div className="bg-white p-6 shadow-lg border-l-4 border-slate-400">
                  ...
                  <p>
                    "Un délai annoncé est un délai respecté." Cette phrase résume notre philosophie.
                    Avec 30 collaborateurs expérimentés et une organisation rodée, nous tenons nos
                    engagements de planning à 98%. Parce que votre temps a de la valeur.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="sticky top-8 space-y-6">
              ...
              <div className="bg-yellow-500 text-slate-900 p-8">
                ...
                <p className="font-medium">
                  "Un délai annoncé est un délai respecté."
                </p>
              </div>
            </div>
          </div>
        ...
        {/* Section Expertise - Grid moderne */}
        ...
        {/* Section Secteurs - Design split avec couleurs cohérentes */}
        ...
        <div className="space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            {team.map((member, index) => (
              <div key={index} className="bg-white shadow-xl overflow-hidden group hover:-translate-y-2 transition-all duration-300">
          ...
          <div className="bg-slate-50 p-12 text-center">
            <h3 className="text-3xl font-bold text-slate-900 mb-6">30 Collaborateurs à Votre Service</h3>
            <p className="text-lg text-slate-600 max-w-3xl mx-auto leading-relaxed">
              Électriciens qualifiés, plombiers expérimentés, maçons chevronnés, compagnons polyvalents,
              chefs d'équipe rigoureux et conducteurs de travaux certifiés… Notre entreprise réunit tous
              les savoir-faire essentiels du bâtiment. Chaque membre partage la même exigence de qualité
              et la passion du travail bien fait, transmise de père en fils.
            </p>
          </div>
        </div>

        {/* Section Certifications - Grid simple */}
        <div className="space-y-12">
          <div className="text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {certifications.map((cert, index) => (
              <div key={index} className="bg-white shadow-lg p-8 text-center hover:shadow-2xl hover:-translate-y-2 transition-all duration-300">
      ...
      <div className="bg-slate-900 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-slate-300 mb-12 leading-relaxed">
            De père en fils, 13 ans de savoir-faire, 98% de délais respectés,
            plus de 500 clients qui nous font confiance
          </p>
